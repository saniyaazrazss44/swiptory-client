...
import EditStoryIcon from '../../assets/icons/edit-icon.png'
    ...
    return (
        <div>
            ...
            >
                ...
                <div className='addstorySlideText1'>
                    <h3 className='dmsans-medium'>Add story to feed</h3>
                </div>

                <div className='addStoryBtnAndContent'>
                ...
                <div className='addstoryFooterButtons'>
                    ...
                    <div>
                        <button onClick={handleEditPost} className='btnPost dmsans-bold'>
                            Post
                        </button>
                    </div>
                </div>
            </Modal>
            <button onClick={openModal} className='editStoryMain'>
                <img src={EditStoryIcon} alt="edit story" />
                <h3 className='dmsans-medium'>Edit story</h3>
            </button>
        </div>
    )
}
